...
- [ ] Liens Behance, GitHub, Instagram (encore en TODO)
- [ ] Formspree (formulaire contact)
- [ ] OG Image pour partages sociaux

### Composants
- **Navigation** : Fixed, marquee noire + nav avec logo R. a gauche et items a droite (border-x-2, items-stretch)
- **Hero** : Grille 3fr/2fr, photo ronde aspect-square, boutons LinkedIn + CV
- **PersonalitySection** : 4 axes avec curseurs animes
- **DesignSkills** : Section competences design
- **DevSkills** : Section dev style terminal
- **WritingSection** : Articles + Instagram
- **ContactForm** : Formulaire (Formspree a configurer)
