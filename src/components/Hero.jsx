      ...
      <div className="grid md:grid-cols-[3fr,2fr] gap-0 border-2 border-noir dark:border-blanc">
        ...
        <div className="p-8 md:p-12 border-r-2 border-noir dark:border-blanc">
          ...
          <div className="flex flex-wrap items-center gap-6 mt-8">
            ...
            <motion.a
              ...
              download
              className="inline-flex items-center gap-2 text-sm text-noir dark:text-blanc hover:underline transition-all"
              variants={fadeInUp}
              initial="initial"
              animate="animate"
        ...
        >
          <img
            ...
            className="w-full h-full rounded-full border-2 border-noir dark:border-blanc object-cover"
          />
        </motion.div>
      </div>
    </section>
